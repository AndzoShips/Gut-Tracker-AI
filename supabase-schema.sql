...
-- Note: Since we're using Whop authentication (not Supabase Auth),
-- we'll handle access control in the API layer.
-- These policies allow all operations, but our API verifies Whop user ID.
